...
<body>
	...
	<div class="all-item">
		...
		<form action="addStadium2.php?action=add" method="POST" enctype="multipart/form-data ">
		<div class="addForm">

				<div class="leftcol ">
					<div class=input-col1>
						<label for="prodId">STADIUM ID</label>
						<input type="text" id="stadium-id" name="stadium-id" required><br>
					</div>
					<div class="input-col1">
						<label for="prodId">STADIUM NAME</label>
						<br><input type="text" name="stadium-name" required><br>
					</div>
					<div class="input-col1">
						<label for="prodId">NO OF SECTION</label>
						<input type="text" name="no-section" required><br>
					</div>
				</div>
				<div class="rightcol" >
					<center>
			...
			<center><button type="submit" value="Add product" name="submit">ADD STADIUM</button></center>
