...
<body>
	...
	<div class="top-nav">
		...
		<div class="bar-nav" id="myTopnav">
			<div class="dropdown">
			<button class="dropbtn" onclick="clickFunc()">STADIUM</button>
				<div class="dropdown-content" id="myDropdown">
					<a href="display-stdorg.php">ADD ORGANIZER</a>
					<a href="display-stadium.php">ADD STADIUM</a>
				</div>
			</div>
			<a href="display-match.php"><div class="nav-menu-1"><p>MATCH</p></div></a>
			<a href="display-team.php"><div class="nav-menu-1"><p>TEAM</p></div></a>
			<a href="activeorders.php"><div class="nav-menu-1"><p>ACTIVE ORDERS</p></div></a>
