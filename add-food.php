...
<?php
      if(isset($_GET['action'])){
	    ...
	    $sql= "INSERT INTO food (foodID,foodDesc,stadiumID,price,food_img) VALUES ('$foodid','$fooddesc','$stadiumID','$price','$img');";
        $result=mysqli_query($conn,$sql);
        
        echo "<script>alert('Food successfully add');";
...
<body>
	...
	<div class="main-box">
		...
		<form action="add-food.php?action=add" method="POST" enctype="multipart/form-data " >
		<div class="addForm">
				...
				<div class="details" >
					...
					<div class="part-detail">
                       ...
                       <div class="data-cust">
						<input type="text" id="foodDesc" name="foodDesc" required>
					</div>
				</div>
           ...
           <div class="submit">
	      <center><input type="submit" value="Add New Food" name="add">
		</div>
					</div>
					</center>
				</div>
