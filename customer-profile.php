	...
	<div class="main-box">
				...
				?>
					<div class="details">
						...
						<div class="part-detail">
							...
							<div class="data-cust">: 
								<input type="text" name="phoneNo" value="<?php echo $phone ;?>" required>
							</div>
						</div>
						<div class="part-detail">
		...
		<div class="order-history">
			...
			<div class="table-order-history">
				...
				<?php 
				$sql = "SELECT * FROM booking WHERE username = '".$username."'"; //adel123 ni ubah kepada $_SESSION['username']
				$result = mysqli_query($conn, $sql);
				...
				while ($row = mysqli_fetch_assoc($result)) { ?>
					<tr>
						<td class="order-id"><a href="printReceipt.php?bookingID=<?php echo $row['bookingID']?>" ><?php echo $row['bookingID']?></a></td> <!-- href=receipt.php-->
...
<?php
	...
	if(isset($_GET['action'])){
		if($_GET['action'] == "edit"){
			...
			$sql = "UPDATE user SET email='$new_email', phone='$new_phoneNo', address='$new_address' WHERE username='$user';";
			$result = mysqli_query($conn, $sql);
